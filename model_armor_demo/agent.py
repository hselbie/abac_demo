...
async def model_armor_callback(
    ...
    client = modelarmor_v1.ModelArmorAsyncClient(client_options={"api_endpoint": "modelarmor.us-central1.rep.googleapis.com"})
    prompt_data = modelarmor_v1.DataItem(text=llm_request.contents[-1].parts[0].text)
    request = modelarmor_v1.SanitizeUserPromptRequest(
        name=f"projects/{GOOGLE_CLOUD_PROJECT_ID}/locations/us-central1/templates/{TEMPLATE_ID}",
